//Note:
/*
    Loads a DDS file from disk, this should be in a converter tool not runtime in future.
*/
#pragma once
...
// the classic dds header everyone uses
namespace DDS
{
#pragma pack(push,1)
...
#define ISBITMASK( r,g,b,a ) ( ddpf.RBitMask == r && ddpf.GBitMask == g && ddpf.BBitMask == b && ddpf.ABitMask == a )
    ...
    inline SurfaceFormat GetSurfaceFormat(const DDS_PIXELFORMAT& ddpf) noexcept
    {
        if (ddpf.flags & DDS_RGB)
        {
            ...
            case 32:
                ...
                {
                    return SurfaceFormat::R10G10B10A2_Unorm;
                }

                if (ISBITMASK(0x0000ffff, 0xffff0000, 0, 0))
                {
                    return SurfaceFormat::R16G16_Unorm;
                }

                if (ISBITMASK(0xffffffff, 0, 0, 0))
                {
                    return SurfaceFormat::R32_Float;
                }
                break;
            }
        }
        else if (ddpf.flags & DDS_LUMINANCE)
        {
            if (8 == ddpf.RGBBitCount)
            {
                ...
                {
                    return SurfaceFormat::R8G8_Unorm; // Some DDS writers assume the bitcount should be 8 instead of 16
                }
            }
            ...
            if (16 == ddpf.RGBBitCount)
            {
                ...
                {
                    return SurfaceFormat::R16_Unorm;
                }
                if (ISBITMASK(0x00ff, 0, 0, 0xff00))
                {
        ...
        else if (ddpf.flags & DDS_BUMPDUDV)
        {
            if (16 == ddpf.RGBBitCount)
            {
                ...
                {
                    return SurfaceFormat::R8G8_Snorm;
                }
            }
            ...
            if (32 == ddpf.RGBBitCount)
            {
                if (ISBITMASK(0x000000ff, 0x0000ff00, 0x00ff0000, 0xff000000))
                {
                    return SurfaceFormat::R8G8B8A8_Snorm;
                }
                if (ISBITMASK(0x0000ffff, 0xffff0000, 0, 0))
                {
                    return SurfaceFormat::R16G16_Snorm;
                }
            }
        }
        else if (ddpf.flags & DDS_FOURCC)
        {
            ...
            case 36: // D3DFMT_A16B16G16R16
                return SurfaceFormat::R16G16B16A16_Unorm;

            case 110: // D3DFMT_Q16W16V16U16
                return SurfaceFormat::R16G16B16A16_Snorm;

            case 111: // D3DFMT_R16F
                return SurfaceFormat::R16_Float;

            case 112: // D3DFMT_G16R16F
                return SurfaceFormat::R16G16_Float;

            case 113: // D3DFMT_A16B16G16R16F
                return SurfaceFormat::R16G16B16A16_Float;

            case 114: // D3DFMT_R32F
                return SurfaceFormat::R32_Float;

            case 115: // D3DFMT_G32R32F
                return SurfaceFormat::R32G32_Float;
...
// DDS File for loading a dds file.
class DDSFile
{
public:
    Uint32 Width     = 1;
