<Shader>
	...
	<Properties>
		...
		<Property name="StepSize" type="Vector3" min="0.001" max="1.0"/>
	...
	<Shaders>
		<ShaderPath type="VS" source="Assets/Shaders/Volume/Mip_Volume.hlsl" entry="vert"/>
		<ShaderPath type="FS" source="Assets/Shaders/Volume/Mip_Volume.hlsl" entry="frag"/>
	</Shaders>
</Shader>