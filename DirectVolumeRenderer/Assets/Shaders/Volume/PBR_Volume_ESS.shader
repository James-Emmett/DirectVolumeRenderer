<Shader>
	...
	<Shaders>
		<ShaderPath type="VS" source="Assets/Shaders/Volume/PBR_Volume_ESS.hlsl" entry="vert"/>
		<ShaderPath type="FS" source="Assets/Shaders/Volume/PBR_Volume_ESS.hlsl" entry="frag"/>
	</Shaders>
</Shader>